...
chroot rootdir apt install --no-install-recommends -y bash-completion sudo ssh nano u-boot-tools- ubuntu-desktop-minimal gdm3 snapd- apparmor-utils- apparmor-notify- apparmor-profiles- apparmor-profiles-extra-
